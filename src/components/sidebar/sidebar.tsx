...
const navigation = [
    ...
    { name: 'Invoice', href: '#', icon: FolderIcon, count: '12', current: false },
    { name: 'Payments', href: '#', icon: CalendarIcon, count: '20+', current: false },
    { name: 'Imputations', href: '#', icon: DocumentDuplicateIcon, current: false },
    // { name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
    { id: 1, name: 'Joram', href: '#', initial: 'J', current: false },
